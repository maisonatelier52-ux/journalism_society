...
export const metadata = {
  title: "Press Releases — Official Statements | Journalism Society",
  description:
    "Official press releases, announcements, and public statements from Journalism Society. Read our latest platform news, editorial decisions, and accountability announcements.",
  keywords: ["journalism society press releases", "official statements media India", "journalism accountability announcements"],
  alternates: { canonical: `${SITE_URL}/press-releases` },
  openGraph: {
    title: "Press Releases | Journalism Society",
    description: "Official announcements and public statements from Journalism Society's editorial team.",
    url: `${SITE_URL}/press-releases`,
    type: "website",
    images: [{ url: `${SITE_URL}/og-image.jpg`, width: 1200, height: 630, alt: "Journalism Society Press Releases" }],
  },
  twitter: { card: "summary", title: "Press Releases | Journalism Society", description: "Official announcements and public statements from Journalism Society." },
};
