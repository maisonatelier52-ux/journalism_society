...
// app/publishing-principles/page.jsx
import PublishingPrinciplesClient from "@/components/PublishingPrinciplesClient";
const SITE_URL = "https://journalism-society.vercel.app";

export const metadata = {
  title: "Publishing Principles — Our Editorial Philosophy | Journalism Society",
  description:
    "The 8 core values guiding every docket Journalism Society publishes: accuracy, fairness, no misleading content, verified evidence, transparency, completeness, independence, and timely publication.",
  keywords: ["publishing principles journalism", "editorial philosophy India", "accuracy in journalism", "evidence-based journalism"],
  alternates: { canonical: `${SITE_URL}/publishing-principles` },
  openGraph: {
    title: "Publishing Principles | Journalism Society",
    description: "Accuracy, fairness, evidence, and independence — the core values behind every docket we publish.",
    url: `${SITE_URL}/publishing-principles`,
    type: "website",
    images: [{ url: `${SITE_URL}/og-image.jpg`, width: 1200, height: 630, alt: "Journalism Society Publishing Principles" }],
  },
  twitter: { card: "summary", title: "Publishing Principles | Journalism Society", description: "The core values guiding every docket we publish." },
};
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: "Publishing Principles", item: `${SITE_URL}/publishing-principles` },
  ],
};
