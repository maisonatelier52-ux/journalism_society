...
// // Editorial principles shown in the new section
...
//                 <Link href="/dockets" className="inline-flex items-center gap-2 bg-[#1e2d4a] text-[#f5f0e8] font-mono-dm text-[0.62rem] tracking-[0.13em] uppercase px-4 sm:px-5 py-2 sm:py-2.5 hover:bg-[#2a3f6a] transition-colors">Browse Dockets</Link>
//                 <a href="#how" className="inline-flex items-center gap-2 bg-transparent text-[#1e2d4a] font-mono-dm text-[0.62rem] tracking-[0.13em] uppercase px-4 sm:px-5 py-2 sm:py-2.5 border-2 border-[#1e2d4a] hover:bg-[#1e2d4a] hover:text-[#f5f0e8] transition-colors">Learn How It Works</a>
//               </div>
//             </div>
...
//             <Link href="/dockets" className="font-mono-dm text-[0.6rem] tracking-[0.1em] uppercase text-[#1e2d4a] no-underline hover:text-[#b8974a] transition-colors">All Dockets →</Link>
//           </div>
...
//                   ))}
//                 </div>
//                 <Link href={`/dockets/${featuredDocket._id}`} className="inline-flex items-center gap-2 bg-[#1e2d4a] text-[#f5f0e8] font-mono-dm text-[0.62rem] tracking-[0.13em] uppercase px-4 sm:px-5 py-2 sm:py-2.5 hover:bg-[#2a3f6a] transition-colors">View Full Record</Link>
//               </div>
//               <div className="hidden md:block min-h-[280px] overflow-hidden">
//                 <img src="https://images.unsplash.com/photo-1555848962-6e79363ec58f?w=700&q=80" alt="Courthouse" className="w-full h-full object-cover sepia-[0.2] brightness-90" />
//               </div>
//             </div>
//           ) : (
...
//             {SECTIONS.map((s) => (
//               <Link key={s.label} href={s.href} className="p-4 sm:p-5 border border-[#d4c8b4] bg-[#faf6ee] hover:bg-white hover:shadow-md transition-all no-underline text-inherit flex flex-col gap-2 sm:gap-2.5 rounded-lg">
...
//         <div className="max-w-6xl mx-auto">
//           <h2 className="font-playfair font-bold text-xl sm:text-2xl md:text-[clamp(1.6rem,4vw,2.2rem)] text-[#1e2d4a] mb-5 sm:mb-7">How It Works</h2>
...
//                 {i < STEPS.length - 1 && <div className="hidden lg:block absolute -right-2 top-[40%] text-[#c8b89a] text-xl font-light">›</div>}
//               </div>
//             ))}
//           </div>
//         </div>
...
//       {/* ── OUR PURPOSE ── */}
//       <section className="bg-[#2a1f14] py-12 sm:py-16 px-4 sm:px-6">
...
//             <h2 className="font-playfair font-bold text-xl sm:text-2xl md:text-[clamp(1.8rem,4vw,3rem)] text-[#f5f0e8] leading-tight mb-4 sm:mb-6">Most reporting shows one side.</h2>
...
//       {/* ── IMPACT STATS ── NEW ── */}
//       <section className="bg-[#1e2d4a] py-10 sm:py-12 px-4 sm:px-6">
//         <div className="max-w-6xl mx-auto">
//           <div className="border-t-2 border-[#b8974a] pt-2.5 mb-7 sm:mb-9">
//             <span className="font-mono-dm text-[0.6rem] tracking-[0.16em] uppercase text-[#b8974a]">By the Numbers</span>
//           </div>
...
//       {/* ── EDITORIAL PRINCIPLES ── NEW ── */}
//       <section className="bg-[#f5f0e8] py-10 sm:py-14 px-4 sm:px-6">
//         <div className="max-w-6xl mx-auto">
...
//               </div>
//               <h2 className="font-playfair font-bold text-xl sm:text-2xl md:text-[clamp(1.6rem,3.5vw,2.2rem)] text-[#1e2d4a] leading-tight max-w-md">
//                 The rules we hold ourselves to.
//               </h2>
//             </div>
//             <Link href="/publishing-principles" className="font-mono-dm text-[0.6rem] tracking-[0.12em] uppercase text-[#b8974a] hover:text-[#1e2d4a] transition-colors whitespace-nowrap">
//               Full Policy →
//             </Link>
//           </div>
...
//                   <div className="w-8 h-8 sm:w-10 sm:h-10 bg-[#1e2d4a] flex items-center justify-center">
...
//       {/* ── RECENT DOCKETS GRID ── NEW ── */}
//       {recentDockets.length > 0 && (
//         <section className="bg-[#ede8dc] border-y border-[#d4c8b4] py-10 sm:py-12 px-4 sm:px-6">
//           <div className="max-w-6xl mx-auto">
//             <div className="border-t-2 border-[#1e2d4a] pt-2.5 mb-5 sm:mb-7 flex justify-between items-baseline">
//               <span className="font-mono-dm text-[0.6rem] tracking-[0.16em] uppercase text-[#9a8870]">Recent Dockets</span>
//               <Link href="/dockets" className="font-mono-dm text-[0.6rem] tracking-[0.1em] uppercase text-[#1e2d4a] no-underline hover:text-[#b8974a] transition-colors">View All →</Link>
//             </div>
//             <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
//               {recentDockets.map((d) => (
//                 <Link key={d._id} href={`/dockets/${d._id}`} className="border border-[#d4c8b4] bg-[#faf6ee] hover:bg-white hover:shadow-md transition-all p-4 sm:p-5 no-underline text-inherit flex flex-col gap-2 group rounded-lg">
...
//       {/* ── MEDIA WATCH PREVIEW ── NEW ── */}
//       {recentMedia.length > 0 && (
//         <section className="bg-[#f5f0e8] py-10 sm:py-12 px-4 sm:px-6">
//           <div className="max-w-6xl mx-auto">
//             <div className="border-t-2 border-[#1e2d4a] pt-2.5 mb-5 sm:mb-7 flex justify-between items-baseline">
//               <span className="font-mono-dm text-[0.6rem] tracking-[0.16em] uppercase text-[#9a8870]">Media Watch</span>
//               <Link href="/media-watch" className="font-mono-dm text-[0.6rem] tracking-[0.1em] uppercase text-[#1e2d4a] no-underline hover:text-[#b8974a] transition-colors">All Coverage →</Link>
//             </div>
//             <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
//               {recentMedia.map((m, i) => {
//                 const stanceColor = m.stance === "adversarial" ? "#b8190c" : m.stance === "supportive" ? "#2d6a4f" : "#5a6a84";
//                 return (
//                   <Link key={m._id || i} href="/media-watch" className="border border-[#d4c8b4] bg-[#faf6ee] hover:bg-white hover:shadow-md transition-all p-4 sm:p-5 no-underline text-inherit flex flex-col gap-2 group overflow-hidden rounded-lg">
//                     <div className="flex items-center justify-between gap-2">
...
//                         <span className="w-1.5 h-1.5 rounded-full" style={{ background: stanceColor }}></span>
//                         {m.stance}
//                       </span>
//                     </div>
...
//       {/* ── TRANSPARENCY PLEDGE ── NEW ── */}
//       <section className="bg-[#f5f0e8] py-10 sm:py-12 px-4 sm:px-6 border-t border-[#d4c8b4]">
//         <div className="max-w-6xl mx-auto">
...
//               </div>
//               <h2 className="font-playfair font-bold text-xl sm:text-2xl text-[#1e2d4a] leading-tight mb-4">
...
//                     <h4 className="font-mono-dm text-[0.6rem] tracking-[0.1em] uppercase text-[#1e2d4a] font-bold">{item.title}</h4>
//                   </div>
...
//             <Link href="#" className="font-mono-dm text-[0.6rem] tracking-[0.1em] uppercase text-[#1e2d4a] no-underline hover:text-[#b8974a] transition-colors">View all →</Link>
//           </div>
//           {loading ? (
...
//           ) : (
//             latestUpdates.map((u) => (
//               <Link key={u.id} href={u.href} className="flex flex-col sm:flex-row sm:items-baseline gap-2 sm:gap-3.5 py-3 sm:py-3.5 border-b border-[#d4c8b4] hover:bg-[#ede8dc] transition-colors no-underline group">
...
//       {/* ── SUBMIT CTA ── NEW ── */}
//       <section className="bg-[#1e2d4a] border-t-4 border-[#b8974a] py-12 sm:py-16 px-4 sm:px-6">
//         <div className="max-w-6xl mx-auto text-center">
//           <p className="font-mono-dm text-[0.58rem] tracking-[0.18em] uppercase text-gray-300 mb-4">Get on the Record</p>
//           <h2 className="font-playfair font-black text-2xl sm:text-3xl md:text-[clamp(2rem,5vw,3.5rem)] text-[#f5f0e8] leading-tight mb-4 sm:mb-5">
...
//             <Link href="/submit" className="inline-flex items-center justify-center gap-2 bg-[#b8974a] text-[#1e2d4a] font-mono-dm text-[0.65rem] tracking-[0.13em] uppercase px-6 sm:px-8 py-3 sm:py-3.5 hover:bg-[#c8a85a] transition-colors font-medium">
//               Submit a Right of Reply →
//             </Link>
//             <Link href="/dockets" className="inline-flex items-center justify-center gap-2 bg-transparent text-[#f5f0e8] font-mono-dm text-[0.65rem] tracking-[0.13em] uppercase px-6 sm:px-8 py-3 sm:py-3.5 border border-white/20 hover:border-white/40 hover:bg-white/5 transition-colors">
...
//             {POLICIES.map((p, i) => (
//               <span key={p.href}>
//                 <Link href={p.href} className="font-mono-dm text-[0.58rem] tracking-[0.1em] uppercase text-[#6a5e4e] hover:text-[#1e2d4a] transition-colors no-underline">{p.name}</Link>
...
// app/page.jsx
// Server component — exports metadata, then renders the client HomePage
...
export const metadata = {
  title: "Journalism Society — Right of Reply. In Full. | Public Record Platform",
  description:
    "Journalism Society is India's independent public record platform. We publish verified Right of Reply responses, corrections, and documented evidence to counter inaccurate reporting. Free to submit. Permanent record.",
  keywords: [
    "right of reply India",
    "journalism accountability",
    "media corrections India",
  ...
  openGraph: {
    ...
    description:
      "India's independent public record platform for Right of Reply responses, verified corrections, and media accountability. Audi alteram partem — hear the other side.",
    url: SITE_URL,
    type: "website",
    images: [{ url: `${SITE_URL}/og-home.jpg`, width: 1200, height: 630, alt: "Journalism Society — Public Record Platform" }],
  },
  twitter: {
    card: "summary_large_image",
    title: "Journalism Society — Right of Reply. In Full.",
    description: "India's independent public record platform. Every public claim deserves a documented, permanent response.",
...
const homepageSchema = {
  ...
  "@type": "WebPage",
  name: "Journalism Society — Right of Reply. In Full.",
  description:
    "India's independent public record platform publishing Right of Reply responses, corrections, and documented evidence.",
  url: SITE_URL,
  speakable: {
