...
//           <div className="mb-5">
//             <label className="font-mono-dm text-xs uppercase text-[#9a8870] block mb-2">Email Address</label>
...
//                 placeholder="admin@journalismsociety.org" required />
//             </div>
//           </div>

//           <div className="mb-6">
//             <label className="font-mono-dm text-xs uppercase text-[#9a8870] block mb-2">Password</label>
//             <div className="relative">
          ...
          <div className="mb-5">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-3 py-2 border border-[#d4c8b4] text-gray-800 font-garamond focus:outline-none focus:border-[#1e2d4a]"
                placeholder="admin@journalismsociety.org"
                required
              />
            </div>
          </div>
