...
// ============================================================
// FILE: app/document-room/page.jsx
// ============================================================

import DocumentRoomClient from "@/components/DocumentRoomClient";
const SITE_URL = "https://journalism-society.vercel.app";

export const metadata = {
  title: "Document Room — Legal Records & Exhibits | Journalism Society",
  description:
    "Access all public records, legal documents, correspondence, and supporting exhibits from every Journalism Society docket. Fully searchable, freely downloadable, and permanently archived.",
  keywords: ["public legal documents India", "journalism society document room", "right of reply exhibits", "legal records media India"],
  alternates: { canonical: `${SITE_URL}/document-room` },
  openGraph: {
    title: "Document Room — Legal Records & Exhibits | Journalism Society",
    description: "Freely access all documents, exhibits, and supporting records from every published docket.",
    url: `${SITE_URL}/document-room`,
    type: "website",
    images: [{ url: `${SITE_URL}/og-image.jpg`, width: 1200, height: 630, alt: "Journalism Society Document Room" }],
  },
  twitter: {
    card: "summary_large_image",
    title: "Document Room | Journalism Society",
    description: "All legal records, exhibits, and public documents from every Right of Reply docket.",
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: "Document Room", item: `${SITE_URL}/document-room` },
  ],
};
...
const collectionSchema = {
  "@context": "https://schema.org",
  "@type": "CollectionPage",
  name: "Document Room — Journalism Society",
  description: "All legal documents, exhibits, and public records from every Right of Reply docket.",
  url: `${SITE_URL}/document-room`,
};
