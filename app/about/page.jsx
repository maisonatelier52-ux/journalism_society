...
// ============================================================
// app/about/page.jsx  — SERVER COMPONENT with SEO metadata
// ============================================================
// Replace the existing "use client" page with this server wrapper.
// Move all the existing client-side JSX into app/about/AboutClient.jsx
// and import it here.
...
export const metadata = {
  ...
  openGraph: {
    ...
    url: `${SITE_URL}/about`,
    type: "website",
    images: [{ url: `${SITE_URL}/og-about.jpg`, width: 1200, height: 630, alt: "About Journalism Society" }],
  },
  twitter: {
...
const aboutPageSchema = {
  "@context": "https://schema.org",
  "@type": "AboutPage",
  name: "About Journalism Society",
  description: "Learn about Journalism Society's mission to build public accountability through the Right of Reply.",
  url: `${SITE_URL}/about`,
  mainEntity: {
    "@type": "Organization",
    name: "Journalism Society",
    foundingDate: "2024",
    description: "India's independent public record platform for Right of Reply responses.",
    areaServed: "IN",
  },
};
