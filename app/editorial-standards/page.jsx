...
// app/editorial-standards/page.jsx
import EditorialStandardsClient from "@/components/EditorialStandardsClient";
const SITE_URL = "https://journalism-society.vercel.app";

export const metadata = {
  title: "Editorial Standards — How We Review & Publish | Journalism Society",
  description:
    "Journalism Society's editorial standards: how submissions are reviewed, verified, and published. Who makes the decisions, our full workflow, and the content we publish or reject.",
  keywords: ["editorial standards journalism", "press review process India", "journalism society standards", "media verification process"],
  alternates: { canonical: `${SITE_URL}/editorial-standards` },
  openGraph: {
    title: "Editorial Standards | Journalism Society",
    description: "How we review, verify, and publish Right of Reply submissions. Transparent editorial governance.",
    url: `${SITE_URL}/editorial-standards`,
    type: "website",
    images: [{ url: `${SITE_URL}/og-image.jpg`, width: 1200, height: 630, alt: "Journalism Society Editorial Standards" }],
  },
  twitter: { card: "summary", title: "Editorial Standards | Journalism Society", description: "Our review process, verification workflow, and publishing standards — fully disclosed." },
};
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: "Editorial Standards", item: `${SITE_URL}/editorial-standards` },
  ],
};
