...
// import { FiEye, FiClock, FiCheckCircle, FiXCircle, FiArrowRight } from "react-icons/fi";
...
//   return (
//     <div>
//       <h1 className="font-playfair font-black text-3xl text-[#1e2d4a] mb-2">Submissions</h1>
//       <p className="font-garamond text-[#7a6e5e] mb-8">Review and manage Right of Reply submissions</p>
...
//               <tr>
//                 <th className="text-left py-3 px-4 font-mono-dm text-xs text-[#9a8870] uppercase">Respondent</th>
//                 <th className="text-left py-3 px-4 font-mono-dm text-xs text-[#9a8870] uppercase">Title</th>
//                 <th className="text-left py-3 px-4 font-mono-dm text-xs text-[#9a8870] uppercase">Source</th>
...
//                       </td>
//                       <td className="py-3 px-4">
//                         <p className="font-garamond text-sm text-[#5a5040]">{sub.responseTitle}</p>
//                       </td>
//                       <td className="py-3 px-4">
...
//                       </td>
//                       <td className="py-3 px-4">
//                         <span className="inline-block px-2 py-1 text-xs font-mono-dm" style={{ background: status.bg, color: status.text, border: `1px solid ${status.border}` }}>
//                           {sub.status}
//                         </span>
//                       </td>
//                       <td className="py-3 px-4">
