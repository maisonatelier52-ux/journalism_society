...
export const metadata = {
  title: "Submit a Right of Reply — Free & Permanent | Journalism Society",
  description:
    "Submit your Right of Reply to Journalism Society's public record. Free to submit, reviewed within 48 hours, and published permanently alongside the original claim. Correct false reporting today.",
  keywords: [
    "submit right of reply India",
    "file response to media India",
    "journalism society submit",
    "correct false reporting India",
    "defamation response India",
    "media correction submission",
  ],
  alternates: { canonical: `${SITE_URL}/submit` },
  openGraph: {
    title: "Submit a Right of Reply — Free & Permanent | Journalism Society",
    description: "File your documented response for permanent public record. Free to submit, reviewed within 48 hours.",
    url: `${SITE_URL}/submit`,
    type: "website",
    images: [{ url: `${SITE_URL}/og-image.jpg`, width: 1200, height: 630, alt: "Submit a Right of Reply — Journalism Society" }],
  },
  twitter: {
    card: "summary_large_image",
    title: "Submit a Right of Reply | Journalism Society",
    description: "Free. Permanent. Reviewed within 48 hours. File your Right of Reply today.",
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: "Submit a Reply", item: `${SITE_URL}/submit` },
  ],
};
...
const submitPageSchema = {
  ...
  "@type": "WebPage",
  name: "Submit a Right of Reply",
  description: "Submit your documented Right of Reply response to Journalism Society's permanent public record.",
  url: `${SITE_URL}/submit`,
  potentialAction: {
    "@type": "Action",
    name: "Submit Right of Reply",
    target: `${SITE_URL}/submit`,
  },
};
...
const faqSchema = {
  ...
  mainEntity: [
    {
      "@type": "Question",
      name: "Is it free to submit a Right of Reply?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Yes. Submission to Journalism Society's public record is completely free. There are no fees, no paywalls, and no charges for respondents.",
      },
    },
    {
      "@type": "Question",
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "Our editorial team aims to review all submissions within 3–5 business days. You will be contacted at the email you provide.",
      },
    },
    {
      "@type": "Question",
      name: "What happens after my submission is published?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Your response is published permanently as a public docket, accessible to anyone worldwide. It is archived and cannot be removed except in rare cases of proven factual error or legal necessity.",
      },
    },
  ],
};
...
export default function SubmitPage() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(submitPageSchema) }} />
