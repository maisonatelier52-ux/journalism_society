...
export const metadata = {
  title: "Corrections & Clarifications — Public Log | Journalism Society",
  description:
    "Journalism Society's public corrections log. Every factual error, clarification, and update we make is recorded here transparently. We correct mistakes openly and permanently.",
  keywords: ["journalism corrections policy", "public corrections log", "media transparency India", "editorial corrections"],
  alternates: { canonical: `${SITE_URL}/corrections` },
  openGraph: {
    title: "Corrections & Clarifications | Journalism Society",
    description: "Our public log of every correction and clarification. Transparency is non-negotiable.",
    url: `${SITE_URL}/corrections`,
    type: "website",
    images: [{ url: `${SITE_URL}/og-image.jpg`, width: 1200, height: 630, alt: "Journalism Society Corrections" }],
  },
  twitter: { card: "summary", title: "Corrections | Journalism Society", description: "Every correction we make is logged here publicly." },
};
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: "Corrections", item: `${SITE_URL}/corrections` },
  ],
};
