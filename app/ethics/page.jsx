...
import EthicsClient from "@/components/EthicsClient";
const SITE_URL = "https://journalism-society.vercel.app";

export const metadata = {
  title: "Ethics Policy — Our Integrity Framework | Journalism Society",
  description:
    "The ethical framework governing Journalism Society's editorial decisions: fairness to all parties, no bias, respect for privacy, conflict of interest disclosure, and prohibited content policies.",
  keywords: ["journalism ethics policy India", "editorial ethics framework", "media ethics India", "press ethics"],
  alternates: { canonical: `${SITE_URL}/ethics` },
  openGraph: {
    title: "Ethics Policy | Journalism Society",
    description: "Our ethical framework for fairness, independence, and integrity in every editorial decision.",
    url: `${SITE_URL}/ethics`,
    type: "website",
    images: [{ url: `${SITE_URL}/og-image.jpg`, width: 1200, height: 630, alt: "Journalism Society Ethics Policy" }],
  },
  twitter: { card: "summary", title: "Ethics Policy | Journalism Society", description: "Fairness, no bias, no manipulation. Our ethical framework in full." },
};
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: "Ethics Policy", item: `${SITE_URL}/ethics` },
  ],
};
